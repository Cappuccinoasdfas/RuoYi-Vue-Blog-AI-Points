<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="回复的目标用户ID" prop="replyToUserId">
        <el-input
          v-model="queryParams.replyToUserId"
          placeholder="请输入回复的目标用户ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['blog_comment:comment:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['blog_comment:comment:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['blog_comment:comment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['blog_comment:comment:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="回复的目标用户ID" align="center" prop="replyToUserId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="回复的目标用户ID" prop="replyToUserId">
              <el-input v-model="form.replyToUserId" placeholder="请输入回复的目标用户ID" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
<script>
import { listComment, getComment, delComment, addComment, updateComment } from "@/api/blog_comment/comment"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('blog_comment/comment/export', {
        ...this.queryParams
