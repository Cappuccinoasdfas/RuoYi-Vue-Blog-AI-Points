 ...
 */
@RestController
@RequestMapping("/blog_comment/comment")
public class BlogCommentController extends BaseController
{
     ...
     * 查询博客评论列表
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:list')")
    @GetMapping("/list")
     ...
     * 导出博客评论列表
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:export')")
     ...
     * 获取博客评论详细信息
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增博客评论
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:add')")
     ...
     * 修改博客评论
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:edit')")
     ...
     * 删除博客评论
     */
    @PreAuthorize("@ss.hasPermi('blog_comment:comment:remove')")
